...
public:
     ...
     *
     * Si el socket detecto que la conexión fue cerrada, se lanza la excepcion ConexionCerradaError
     *
     ...
     * Si hay un error se lanza una excepción.
     *
     * Si se cerro la conexion (ya sea que se enviaron algunos o ningun byte) se lanza la excepcion
    ...
    // Desconecta y cierra el socket. Por lo menos en el contexto de mi programa, no tiene sentido
