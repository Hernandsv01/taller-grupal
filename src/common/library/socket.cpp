...
Socket Socket::accept() {
    ...
    if (peer_skt == -1) {
        ...
        // me devuelva el mismo error que si genuinamente falló el accept.
        // Devuelvo un error de conexion cerrada, sabiendo que quien cierra el
        // socket debe atraparla (si cerro el listen a posta).
